...
export const heroContent = {
  headline: "Conhecimento é o primeiro passo para viver com mais qualidade.",
  subheadline:
  ...
  howToAccess: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "O produto é entregue com nota fiscal, dentro das normas da ANVISA. Da consulta até o produto chegar em casa, o processo pode levar alguns dias.",
      },
    ],
  },
...
export const aboutContent = {
  ...
  futureDoctorsTeaser: {
    ...
    text: "Em breve. Um espaço exclusivo para profissionais de saúde protocolos clínicos e suporte para prescrição. Cadastre seu interesse em ser um médico prescritor.",
