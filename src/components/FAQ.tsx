...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-12 lg:py-18 bg-surface-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center bg-linear-to-br from-brand-surface to-brand-surface rounded-3xl p-10 border border-brand-primary/15">
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 bg-brand-primary hover:bg-brand-primary text-white px-8 py-4 rounded-2xl font-bold transition-all hover:scale-105 shadow-lg"
          >
