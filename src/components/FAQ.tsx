...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="py-12 lg:py-24 bg-surface-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`w-8 h-8 rounded-lg shrink-0 flex items-center justify-center text-sm font-bold transition-colors ${
                      isOpen ? "bg-brand-primary text-white" : "bg-brand-surface text-text-secondary/80"
                    }`}>
                  ...
                  <div className={`shrink-0 w-6 h-6 rounded-full flex items-center justify-center transition-all duration-300 mt-0.5 ${
                    isOpen ? "bg-brand-surface text-brand-primary rotate-180" : "bg-brand-surface text-text-secondary/70"
                  }`}>
        ...
        {/* Bottom CTA */}
        <div className="text-center bg-linear-to-br from-brand-surface to-brand-surface rounded-3xl p-10 border border-brand-primary/15">
          <div className="w-14 h-14 bg-brand-surface rounded-2xl flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-text-secondary mb-6 max-w-md mx-auto">
            {faqContent.cta}. Nossa equipe está pronta para responder.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 bg-whatsapp-green hover:bg-brand-primary text-white px-8 py-4 rounded-2xl font-bold transition-all hover:scale-105 shadow-lg"
          >
