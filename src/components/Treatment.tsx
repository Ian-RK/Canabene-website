...
export default function Treatment() {
  return (
    <section id="tratamento" className="py-24 lg:py-32 bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* How It Works */}
        <div className="bg-gradient-to-br from-green-600 to-teal-700 rounded-3xl p-8 lg:p-12 mb-12 text-white">
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <div className={`text-3xl font-black ${
                  compound.color === "green" ? "text-green-600" : "text-teal-600"
                } leading-none`}>
                  {compound.acronym}
                </div>
                <div>
                  <div className="font-bold text-gray-900 text-lg">{compound.name}</div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          <div>
            ...
            <div className="grid grid-cols-1 gap-3">
              {treatmentContent.conditions.list.map((condition) => (
                <div
                  key={condition}
                  className="flex items-center gap-3 p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:border-green-200 hover:shadow-md transition-all"
                >
            ...
            <p className="mt-4 text-xs text-gray-500 italic">{treatmentContent.conditions.disclaimer}</p>
          </div>
          ...
          <div>
              ...
              {treatmentContent.howToAccess.steps.map((step, i) => (
                <div key={step.number} className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 bg-green-600 text-white rounded-2xl flex items-center justify-center font-bold text-sm">
                      {step.number}
                    </div>
                    {i < treatmentContent.howToAccess.steps.length - 1 && (
                      <div className="w-0.5 h-6 bg-green-200 mx-auto mt-2" />
                    )}
                  </div>
                  <div className="pb-2">
            ...
            <div className="mt-8 p-6 bg-green-50 rounded-2xl border border-green-200">
              <p className="text-green-800 font-medium mb-4 text-sm">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl font-semibold transition-all hover:scale-105 text-sm"
              >
